...
- User login to EBMUD is always manual. Optional browser help may resume only after the user confirms they're logged in.
- Don't change EBMUD billing, autopay, contact, account, service, household profile, or settings pages.
