...
- Baseline is estimated from recent winter/spring periods when possible; it's a heuristic household pattern clue, not an official indoor-use classification.
- Seasonal or outdoor lift is estimated as usage above the baseline; it's a heuristic clue, not proof of irrigation, leak, or waste.
...
Mud Buddy isn't a formal water audit, plumbing inspection, leak detector, or official EBMUD analysis. It's a practical interpretation layer for homeowner decision-making.
