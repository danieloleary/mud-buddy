...
It is OK to provide the downloaded EBMUD usage file to this local command or to a local coding agent helping in this repo. Don't provide credentials, MFA codes, cookies, localStorage, sessionStorage, auth headers, or session tokens.
