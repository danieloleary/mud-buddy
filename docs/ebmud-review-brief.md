...
- Product: private browser-local EBMUD CSV analyzer.
...
- Privacy model: the public app reads the selected CSV in the browser and does not upload it to a Mud Buddy server.
