...
The browser report should not render account numbers, meter IDs, filenames, raw usage-file rows, service addresses, local paths, or exact private identifiers.
