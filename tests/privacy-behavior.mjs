...
await new Promise((resolve, reject) => {
  const child = spawn(process.platform === 'win32' ? 'python' : 'python3', ['scripts/generate_report.py', csv, '--out', publicOut, '--public', '--address', '123 Private Oak Drive', '--household', 'Family vacation July 10-20', '--irrigation', 'Meter MTR-PRIVATE-777'], { cwd: root, stdio: 'inherit' });
