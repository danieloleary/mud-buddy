...
const required = [
  ...
  'MUD_BUDDY_REAL_CSV',
  'committed synthetic sample usage file',
...
const forbidden = [
  'do not upload raw EBMUD usage files to cloud services',
  'Do not upload raw usage files by default',
  ...
  "The generator may read Dan's local usage file",
